...
//const char *ssid =  "Ip";     // ten wifi
//const char *pass =  "1234567890"; // pass wifi

const char *ssid =  "Linh FPT";     // ten wifi
const char *pass =  "Lincoln235711"; // pass wifi

#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define MQTT_NAME "DaSunGod"
#define MQTT_PASS "aio_XxZV94tPGQmiMgwEYcGERS0UMOcb"
WiFiUDP ntpUDP;
...
void loop() {
 ...
 s3 = digitalRead(slot3);
  ...
  //dieu khien va gui du lieu len adafruit IO cua IR3
